# train_digits.py - Lab 3: a real (small) AI job on Sol
# Trains a digits classifier with scikit-learn from ASU's mamba-managed
# Python environments; no internet download is needed during the job.
