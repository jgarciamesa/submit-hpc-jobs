# train_gpu.py - Lab 4: a real AI job on a Sol GPU node
# Trains a small neural network (PyTorch) on a synthetic dataset generated
# in-script - no internet download needed, runs in about 1-2 minutes on 1 GPU.
# Prints nvidia-smi output so you can SEE the GPU your job landed on.
...
if device.type != "cuda":
    print("WARNING: no GPU visible - job may have landed on a CPU-only allocation.")
...
print("Your AI workload just trained on a university supercomputer GPU.")
